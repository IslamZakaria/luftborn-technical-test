...
<div class="landing-page">
  ...
  <section class="hero-section text-center py-5">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <h1 class="display-4 fw-bold mb-3 animate-fade-in-down text-dark">Hi, I'm Islam Mohamed</h1>
          ...
          <div class="action-buttons animate-fade-in-up delay-200">
            <a routerLink="/auth/login" class="btn btn-primary btn-lg me-3 px-4 shadow-sm">
  ...
  <section class="tech-stack-section py-5">
    <div class="container">
      <h3 class="text-center mb-5 animate-fade-in text-dark">Technical Stack</h3>
      <div class="row justify-content-center g-4">
        ...
        <div class="col-md-4 col-sm-6 animate-fade-in delay-100">
          <div class="tech-card text-center p-4 h-100 border rounded shadow-sm hover-lift">
            ...
            <h5 class="fw-bold text-dark">.NET 10</h5>
        ...
        <div class="col-md-4 col-sm-6 animate-fade-in delay-150">
          <div class="tech-card text-center p-4 h-100 border rounded shadow-sm hover-lift">
            ...
            <h5 class="fw-bold text-dark">Angular</h5>
        ...
        <div class="col-md-4 col-sm-6 animate-fade-in delay-200">
          <div class="tech-card text-center p-4 h-100 border rounded shadow-sm hover-lift">
            ...
            <h5 class="fw-bold text-dark">PostgreSQL</h5>
        ...
        <div class="col-md-4 col-sm-6 animate-fade-in delay-250">
          <div class="tech-card text-center p-4 h-100 border rounded shadow-sm hover-lift">
            ...
            <h5 class="fw-bold text-dark">Clean Architecture</h5>
            <p class="small text-muted mb-0">Maintainable application structure</p>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 animate-fade-in delay-300">
          <div class="tech-card text-center p-4 h-100 border rounded shadow-sm hover-lift">
            ...
            <h5 class="fw-bold text-dark">Docker</h5>
  ...
  styles: [`
    ...
    /* Button Hover Fixes */
    .btn:hover {
      color: #fff !important; /* Force white text on primary button hover */
    }
    ...
    /* Prevent text disappearance in cards on hover if applicable */
    .tech-card {
      background-color: #fff;
    ...
    .tech-card:hover h5 {
      color: #0d6efd; /* Bootstrap primary or keep dark */
    }
    .tech-card p {
